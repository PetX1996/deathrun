...
Main()
{
	...
	old.eEnterTrigger.vStartOrigin = old.eEnterTrigger.origin;
	...
	bounce.eEnterTrigger.vStartOrigin = bounce.eEnterTrigger.origin;
	...
	snip.eEnterTrigger.vStartOrigin = snip.eEnterTrigger.origin;
	...
	knife.eEnterTrigger.vStartOrigin = knife.eEnterTrigger.origin;
	...
	weapon.eEnterTrigger.vStartOrigin = weapon.eEnterTrigger.origin;
...
Room_ShowEnter()
{
	...
	self.eEnterTrigger.origin = self.eEnterTrigger.vStartOrigin;
}

Room_HideEnter()
{
	//self.eBrush MoveTo(self.eBrush.vStartOrigin + (0, 0, -176), 3);
	self.eEnterTrigger.origin = self.eEnterTrigger.vStartOrigin + (0, 0, -100000);
}
