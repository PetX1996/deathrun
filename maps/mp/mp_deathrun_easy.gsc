...
main()
{
	...
	mapper\_music::PlayNow("music_easy", "Pendulum - Crush");
    ...
    mapper\_mapinfo::RegDescription(3, "  21 Traps");
    mapper\_mapinfo::RegDescription(4, "  8 Bonus ends");
    mapper\_mapinfo::RegDescription(5, "  Special bonuses");
    mapper\_mapinfo::RegDescription(6, "  Optional map modes");
    mapper\_mapinfo::RegDescription(7, "  WwW.4GF.Cz");
    mapper\_mapinfo::RegDescription(8, "Current version - 1.2F");
...
SetTimeLimit( time )
{
    api\gamelogic\_classic::RegTimeLimit(time);
}
