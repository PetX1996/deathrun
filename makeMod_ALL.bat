...
echo.   I========================================================================I
echo.   I                                                                        I
echo.   I                       DEATHRUN = MOD = COMPILER                        I
echo.   ==========================================================================
echo.   I                                 V1.1                                   I
...
set runSettings="+set developer 1 +set developer_script 0 +set debug 1 +set con_debug 1 +exec deathrun.cfg +set scr_DEVEnabled 1 +set g_gametype deathrun +devmap mp_deathrun_zero"
...
IWDPacker.exe -gameDir="%GAMEDIR%" -ffName="mod" -verbose -debugUnusedInDirs -outputFile="%OUTPUTDIR%\dr.iwd" -compression=%iwdQuality% -imagesDir="%SOURCEDIR%\images" -soundsDir="%SOURCEDIR%\sound" -weaponsDir="%SOURCEDIR%\weapons\mp" -includeCodImages -includeCodSounds -includeCodWeapons %iwdSettings%
...
if not exist "%OUTPUTDIR%\dr.iwd" call:FUNC_RUN_ERRORS "Could not find dr.iwd"
goto FINAL
