 ...
 trap1()
{
		...
		while(1)
        {
                if (IsDefined(trap1_1)) trap1_1 rotateyaw (360 ,1);
				if (IsDefined(trap1_2)) trap1_2 rotateyaw (360 ,1);
				if (IsDefined(trap1_3)) trap1_3 rotateyaw (360 ,1);
				if (IsDefined(trap1_4)) trap1_4 rotateyaw (360 ,1);
				if (IsDefined(trap1_5)) trap1_5 rotateyaw (360 ,1);
				if (IsDefined(trap1_6)) trap1_6 rotateyaw (360 ,1);
				if (IsDefined(trap1_7)) trap1_7 rotateyaw (360 ,1);
	wait 1;
        }
}
