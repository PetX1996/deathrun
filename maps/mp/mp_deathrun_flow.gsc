main()
{
	api\gamelogic\_classic::RegTimeLimit(10);
...
jump_height_trig()
{
	...
	api\clients\_afk::RegStuck("allies", true);
	api\clients\_afk::RegStuck("axis", true);
...
//    level notify( "addtime",  "240" );
	...
	api\clients\_afk::RegStuck("allies", false);
	api\clients\_afk::RegStuck("axis", false);
